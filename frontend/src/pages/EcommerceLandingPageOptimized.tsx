...
import { AnalyticsEcommerce } from '../components/AnalyticsEcommerce';
...
const CONFIG = {
  ...
  urlSlug: "ecommerce-optimized",
  
  // Hero Section
  heroTitle: "Increase E-commerce Conversion Rates",
  heroSubtitle: "Stop Losing Sales. AI-Driven Conversion Rate Optimization for E-commerce Stores.",
...
const EcommerceLandingPageOptimized: React.FC = () => {
...
export default EcommerceLandingPageOptimized;
...
const CONFIG = {
  ...
  painPoints: [
    "Hidden shipping costs at checkout are the #1 reason for cart abandonment. Your site might be guilty.",
    "Forcing account creation before purchase kills conversion rates. Guest checkout should be seamless.",
    "Trust signals are missing. Without visible security badges or reviews near the 'Buy' button, new visitors won't risk it.",
    "Product descriptions are generic manufacturer copy. They don't answer the specific questions your customers have.",
    "Mobile checkout is a nightmare of tiny forms. If they can't buy with one thumb, they won't buy at all."
  ],
    ...
    "@graph": [
      {
        ...
        "name": "Product Shift for E-commerce",
        "applicationCategory": "BusinessApplication",
        "operatingSystem": "Web Browser",
        "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD", "description": "Free E-commerce Audit" },
        "description": CONFIG.metaDescription,
        "featureList": "Cart Abandonment Analysis, Checkout Flow Optimization, Trust Signal Check",
        "audience": {
          "@type": "Audience",
          "audienceType": "E-commerce Store Owners"
        },
        "offeredBy": {
          "@type": "Organization",
          "name": "Product Shift",

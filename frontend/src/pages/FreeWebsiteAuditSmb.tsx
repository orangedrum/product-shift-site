        ...
        <main className="mt-10 mx-auto max-w-7xl sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28">
          <div className="text-center lg:text-left lg:w-1/2">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline">Free Website Audit</span>{' '}
              <span className="block text-indigo-600 xl:inline">for Small Businesses</span>
            </h1>
            <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              Is your website losing customers? Get an instant, AI-powered audit based on industry usability standards. Find exactly what's broken and how to fix it.
            </p>
    ...
    <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      <div className="bg-white p-8 rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_#000]">
        <h2 className="text-3xl font-extrabold text-gray-900 mb-8 text-center">
          Why Your Small Business Needs a Website Audit
        </h2>
        <ul className="space-y-6 text-lg text-gray-700">
          <li className="flex items-start gap-4">
            ...
            <p>Most small business websites have never had a professional usability audit.</p>
          </li>
          <li className="flex items-start gap-4">
            <div className="flex-shrink-0 w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center border-2 border-black">
              <span className="text-gray-600 font-bold">!</span>
            </div>
            <p>Hidden friction points (like confusing menus or broken forms) are costing you sales every day.</p>
          </li>
          <li className="flex items-start gap-4">
            ...
            <p>Our AI Audit simulates real customer behavior to find issues at a fraction of the cost of an agency.</p>
          </li>
          <li className="flex items-start gap-4">
            <div className="flex-shrink-0 w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center border-2 border-black">
              <Check className="text-indigo-600" size={16} />
            </div>
            <p>Get a clear, prioritized checklist of fixes you can implement immediately.</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="text-center">
        ...
        <p className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
          Audit your website in 3 simple steps
        </p>
      </div>
      <div className="mt-20 grid md:grid-cols-3 gap-x-8 gap-y-12 text-left">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">1. Choose Persona</h3>
            <p className="mt-1 text-base text-gray-600">Select an AI customer profile that matches your target audience (e.g., "Busy Mom").</p>
          </div>
        </div>
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">2. Run Audit</h3>
            <p className="mt-1 text-base text-gray-600">The AI visits your site, attempting to complete goals while noting confusion.</p>
          </div>
        </div>
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">3. Get Report</h3>
            <p className="mt-1 text-base text-gray-600">Receive a comprehensive audit report with actionable fixes to improve conversion.</p>
          </div>
        </div>
      </div>
      </div>
      ...
      <section id="demo" className="bg-gray-50 py-24 sm:py-32">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900">Audit Result for <span className="text-indigo-600">{result.title}</span></h2>
            ...
            <div className="lg:col-span-8 bg-white p-8 rounded-xl border border-gray-200 shadow-lg">
              ...
              <div className="mt-8 p-6 bg-indigo-50 rounded-lg border border-indigo-200 text-center relative">
                <div className="relative z-10">
                  ...
                  <h4 className="font-bold text-indigo-800">Unlock the Full Audit Report</h4>
  ...
  return (
    <section id="demo" className="bg-gray-800 text-white py-24 sm:py-32">
      <div className="container mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl">Try It Now: Free Website Audit</h2>
          ...
          <>
            ...
            <form onSubmit={handleDemoSubmit} className="mt-8 max-w-xl mx-auto flex flex-col gap-3">
              ...
              <button type="submit" disabled={isLoading} className="relative overflow-hidden px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-lg hover:opacity-95 transition-transform transform hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-wait">
                ...
                <span className="relative z-10">{isLoading ? 'Running Audit...' : 'Audit My Site'}</span>
              </button>
            </form>
    ...
    <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="pricing-card bg-white p-6 border border-gray-200 rounded-xl shadow-sm text-left flex flex-col hover:shadow-md transition-shadow">
          <h3 className="text-xl font-bold text-center text-gray-900">Quick Audit</h3>
        ...
        <div className="pricing-card bg-white p-6 border-2 border-indigo-500 rounded-xl shadow-xl text-left flex flex-col relative transform md:-translate-y-4">
          ...
          <h3 className="text-xl font-bold text-center text-gray-900 mt-2">Pro Audit Pack</h3>
          <div className="text-center mt-4">
        ...
        {/* Subscription */}
        <div className="pricing-card bg-white p-6 border border-gray-200 rounded-xl shadow-sm text-left flex flex-col hover:shadow-md transition-shadow">
          <h3 className="text-xl font-bold text-center text-gray-900">Monthly Audits</h3>
          <div className="text-center mt-4">
...
const TestimonialsSection = () => (
  <section className="bg-indigo-900 py-24">
    <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
      ...
      <p className="text-indigo-200 text-lg mb-12 -mt-8">What Other Business Owners See After a Website Audit</p>
...
const FreeWebsiteAuditSmb: React.FC = () => {
  const [searchParams, setSearchParams] = useSearchParams();
  const containerRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    console.log('✅ FreeWebsiteAuditSmb Component Mounted');
    // 1. Capture from URL
  ...
  useEffect(() => {
    document.title = "Free Website Audit for Small Business | Product Shift";
    
    // Programmatically update meta description for SEO
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Get a free website audit for your small business. Our AI agent analyzes your site for usability and conversion issues instantly.");
    } else {
      const meta = document.createElement('meta');
      meta.name = "description";
      meta.content = "Get a free website audit for your small business. Our AI agent analyzes your site for usability and conversion issues instantly.";
    ...
    canonical.setAttribute('href', 'https://app.theproductshift.com/free-website-audit-for-small-business'); // Strictly enforces HTTPS and the correct subdomain
    ...
    setMeta('property', 'og:title', 'Free Website Audit for Small Business');
    setMeta('property', 'og:description', 'Stop losing customers. Get an instant AI website audit based on industry usability standards.');
    setMeta('property', 'og:url', 'https://app.theproductshift.com/free-website-audit-for-small-business');
    ...
    setMeta('name', 'twitter:title', 'Free Website Audit for Small Business');
    setMeta('name', 'twitter:description', 'Stop losing customers. Get an instant AI website audit.');
    ...
    const scriptId = 'json-ld-smb-audit';
        ...
        "@graph": [
          {
            ...
            "offers": { "@type": "Offer", "price": "0", "priceCurrency": "USD", "description": "Free Website Audit" },
            "description": "AI-powered website usability audit for small businesses.",
          ...
          {
            "@type": "VideoObject",
            "name": "Product Shift AI Website Audit Demo",
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes. You get one complete audit with our 'Alex' persona for free. No credit card required."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Google Analytics tells you WHAT is happening (e.g., high bounce rate). Our AI Audit tells you WHY (e.g., 'The pricing is confusing')."
                }
              },
              {
                "@type": "Question",
...
export default FreeWebsiteAuditSmb;
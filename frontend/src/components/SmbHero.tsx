    ...
    <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden text-white">
      ...
      <div className="container mx-auto px-4 relative z-20 text-center max-w-4xl">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
          ...
          <br />
          Powered by AI Customers
        </h1>
        <p className="text-lg md:text-xl mb-8 text-gray-100 max-w-2xl mx-auto">
          Wondering why visitors aren't buying? Get clear, honest feedback from 8 different AI customers in minutes, for a fraction of the cost of a consultant.
        </p>

            ...
            <div className="p-6 bg-gray-50 rounded-xl border border-gray-200 shadow-sm max-w-xs mx-auto lg:mx-0 w-full">
              ...
              <div className="space-y-3">
                 <div className="flex justify-between items-center text-[10px]">
                   ...
                   <span className="font-mono font-bold text-gray-700 text-xs">70%</span>
                 </div>
                 <div className="w-full bg-gray-200 rounded-full h-1.5">
                   <div className="bg-gray-500 h-1.5 rounded-full" style={{ width: '70%' }}></div>
                 </div>
                 <p className="text-[10px] text-gray-400 mt-2">"Users dropped off at /shipping"</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative z-10 mt-auto w-full flex items-end justify-between">
                 ...
                 <div className="flex flex-col items-start relative z-20" style={{ marginLeft: '-6rem', marginBottom: '-2rem' }}>
                    ...
                    <div className="relative bg-white p-5 rounded-2xl border-2 border-black shadow-[4px_4px_0px_0px_#000] mb-4 max-w-sm transform -rotate-1 ml-12">
                        <p className="text-sm font-bold italic text-gray-900 leading-snug">"I can't find the shipping costs anywhere. I'm not going to enter my credit card just to check."</p>
                 ...
                 <div className="bg-white text-gray-900 p-5 rounded-xl border-2 border-black shadow-[4px_4px_0px_0px_#000] relative z-10 w-full max-w-xs mb-12 ml-4">
                    ...
                    <h3 className="text-sm font-bold mb-3 leading-tight">Show Shipping Early</h3>
                    <div className="p-2 bg-indigo-50 border-2 border-indigo-100 rounded text-[10px] font-bold text-indigo-900 flex items-start gap-2">
                      ...
                      <span>FIX: Add "Free shipping over $50" banner.</span>
                    </div>
                 </div>
            </div>
          </div>

...
<ul>
  <li><a href="https://www.theproductshift.com/blog">Read our latest UX Audits</a></li>
  <li><a href="https://www.theproductshift.com/agency-user-testing">Check out our Agency services</a></li>
</ul>
...
<p><a href="https://www.theproductshift.com/ai-powered-ux" style="display: inline-block; background: #000; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">Go to Dashboard</a></p>
`;

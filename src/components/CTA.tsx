          ...
          <Card className="bg-background/95 backdrop-blur-sm border-border/50 shadow-glow">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Discover how Product Shift's AI-powered UX research can deliver real data 
                that transforms your product launches and drives measurable ROI growth.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
                <Button 
                  size="lg" 
                  asChild
                  className="bg-gradient-hero hover:shadow-elegant transition-all duration-300 text-lg px-8 py-6"
                >
                  <a 
